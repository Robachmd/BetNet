"""
Django settings for betrent project.
...
ASGI_APPLICATION = 'betrent.asgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'betrent.pagination.StandardResultsSetPagination',
    'PAGE_SIZE': 20,
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='BetRent <noreply@betrent.com>')
