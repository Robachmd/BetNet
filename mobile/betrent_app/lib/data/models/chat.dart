...
class ConversationListItem {
  ...
  final int id;
  final BetRentUser? otherParticipant;
  ...
  factory ConversationListItem.fromJson(Map<String, dynamic> j) {
    ...
    return ConversationListItem(
      id: j['id'] as int,
      otherParticipant:
          other != null ? BetRentUser.fromJson(_participantToUserJson(other)) : null,
  ...
  /// Chat API returns participant shape; map onto [BetRentUser] fields we need.
